...
@script = <<THE_END
Computer1: Здравствуйте
Computer: This guy to my right,
Computer: he's name is Jason. 
Computer: He is an amazingly talented programmer.
Computer: (sorry,  he made me say that).
Computer: Jason has just finished working with Fuji Xerox,
Computer: in a techical support role.
